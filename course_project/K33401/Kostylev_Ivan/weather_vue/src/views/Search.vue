<template>
<div>
    <div class="container col-xl-10 px-4 py-3">
      <h4 class="display-4 fs-2">Search weather for town</h4>
        <div class="input-group">
          <input type="search" class="form-control rounded" placeholder="Ivanovo" />
