                        ...
                        html += `
                            <div class="d-flex events" id = ${e.id}>
                                ...
                                <div style="width:100%" class="d-flex flex-column justify-content-evenly ms-2">
                                        ...
                                        <span class="fw-light search-type-location-member-icon"> ${eType} . ${e['venue']['city']}, ${e['venue']['country']}</span>
                                        <div class='d-flex justify-content-between search-result-description'>
                                            <span class="fw-light search-type-location-member-icon">${e['venue']['id']} attendees</span>
