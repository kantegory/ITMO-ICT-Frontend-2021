...
function search_5days(){
    ...
    if (name == ''){
        ...
        fetch('https://api.openweathermap.org/geo/1.0/direct?q='+name+'&appid=f3aee66148f3e8248277ba8731f28859&units=metric').then((response) => response.json()).then(json => {
...
function search_now(){
    ...
    if (name == ''){
        ...
        fetch('http://api.openweathermap.org/geo/1.0/direct?q='+name+'&appid=f3aee66148f3e8248277ba8731f28859&units=metric').then((response) => response.json()).then(json => {
            let search_lat = json[0]["lat"];
            let search_lon = json[0]["lon"];
